  ...
  return (
    <section className="landing-section px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="landing-card mt-10 overflow-hidden rounded-2xl shadow-sm transition-shadow duration-300 hover:border-amber-500/20 hover:shadow-md">
              ...
              >
                <h3>
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-base font-semibold text-zinc-100 transition-colors duration-200 hover:bg-white/5"
                    onClick={() =>
                  ...
                  >
                    {item.question}
                    <ChevronDown
                      className={`h-5 w-5 shrink-0 text-zinc-500 transition-transform duration-300 ease-out motion-reduce:transition-none ${isOpen ? "rotate-180" : ""}`}
                      aria-hidden
                    />
                  </button>
                </h3>
                ...
                >
                  <div className="min-h-0">
                    <div
                      className={`px-5 pb-4 text-sm leading-relaxed text-zinc-400 transition-opacity duration-200 ${
                        isOpen
                          ? "opacity-100"
